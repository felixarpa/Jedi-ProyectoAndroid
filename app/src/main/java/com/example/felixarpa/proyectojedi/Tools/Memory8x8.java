    ...
    private void setViewsMemory(int i) {
        switch (i) {
            ...
            case 2:
                ...
                drawables[18]= ContextCompat.getDrawable(getApplicationContext(), R.drawable.cat18);
                drawables[19]= ContextCompat.getDrawable(getApplicationContext(), R.drawable.cat19);
                drawables[20]= ContextCompat.getDrawable(getApplicationContext(), R.drawable.cat20);
                drawables[21]= ContextCompat.getDrawable(getApplicationContext(), R.drawable.cat21);
                drawables[22]= ContextCompat.getDrawable(getApplicationContext(), R.drawable.cat22);
                drawables[23]= ContextCompat.getDrawable(getApplicationContext(), R.drawable.cat23);
                drawables[24]= ContextCompat.getDrawable(getApplicationContext(), R.drawable.cat24);
                drawables[25]= ContextCompat.getDrawable(getApplicationContext(), R.drawable.cat25);
                drawables[26]= ContextCompat.getDrawable(getApplicationContext(), R.drawable.cat26);
                drawables[27]= ContextCompat.getDrawable(getApplicationContext(), R.drawable.cat27);
                drawables[28]= ContextCompat.getDrawable(getApplicationContext(), R.drawable.cat28);
                drawables[29]= ContextCompat.getDrawable(getApplicationContext(), R.drawable.cat29);
                drawables[30]= ContextCompat.getDrawable(getApplicationContext(), R.drawable.cat30);
                drawables[31]= ContextCompat.getDrawable(getApplicationContext(), R.drawable.cat31);
                break;
